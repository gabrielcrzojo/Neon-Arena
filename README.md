...
*   **HTML5:** Estruturação semântica das telas de jogo[cite: 9].
*   **CSS3:** Design responsivo, variáveis para temas e animações de keyframes[cite: 10].
*   **JavaScript (ES6+):** Lógica do jogo, manipulação de DOM e gerenciamento de estado do placar[cite: 8].

## 📂 Estrutura de Arquivos
```text
📁 par-ou-impar/
├── 📄 index.html      # Estrutura principal e containers das telas
├── 📄 style.css       # Estilização completa e efeitos neon
├── 📄 script.js      # Lógica de jogo e interatividade
